const CACHE='trail-scan-v5-20260718';
const LOCAL=['./','./index.html','./login.html',
  './assets/js/public-results.js',
  './assets/js/pending.js',
  './results.html',
  './pending.html','./admin/index.html','./scanner/index.html','./manifest.webmanifest','./assets/config.js','./assets/css/app.css','./assets/js/core.js','./assets/js/idb.js','./assets/js/scanner.js','./assets/js/admin.js'];
const REMOTE=['https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2','https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js','https://cdn.jsdelivr.net/npm/qrcodejs@1.0.0/qrcode.min.js','https://cdn.jsdelivr.net/npm/jszip@3.10.1/dist/jszip.min.js','https://cdn.jsdelivr.net/npm/jspdf@2.5.2/dist/jspdf.umd.min.js'];
