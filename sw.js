const CACHE='trail-scan-v6-6.1.0';
const LOCAL=[
  './','./index.html','./login.html','./pending.html','./results.html',
  './admin/index.html','./scanner/index.html','./manifest.webmanifest',
  './assets/css/app.css?v=6.1.0','./assets/js/core.js?v=6.1.0',
  './assets/js/idb.js?v=6.1.0','./assets/js/login.js?v=6.1.0',
  './assets/js/pending.js?v=6.1.0','./assets/js/public-results.js?v=6.1.0',
  './assets/js/scanner.js?v=6.1.0','./assets/js/admin.js?v=6.1.0'
];
const REMOTE=[
