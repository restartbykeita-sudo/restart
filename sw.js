const CACHE='trail-scan-v7-7.1.0';
const LOCAL=[
  ...
  './assets/css/app.css?v=7.1.0','./assets/js/core.js?v=7.1.0',
  './assets/js/idb.js?v=7.1.0','./assets/js/login.js?v=7.1.0',
  './assets/js/pending.js?v=7.1.0','./assets/js/public-results.js?v=7.1.0',
  './assets/js/scanner.js?v=7.1.0','./assets/js/admin.js?v=7.1.0'
];
const REMOTE=[
