...
ไฟล์คู่มือที่ใช้:
- manual/Trail_Scan_V7_2_User_Manual.pdf
- manual/Trail_Scan_V7_2_User_Manual.docx

ใช้ชื่อไฟล์ภาษาอังกฤษเพื่อป้องกันปัญหาลิงก์ภาษาไทยบน Hosting


# V7.0 — Setup & Race Readiness

เพิ่มระบบนำทางทั้งเว็บไซต์:

- หน้าเริ่มต้นใช้งานแบบ Step-by-step
- สร้าง Event จาก Template พร้อมประเภทและเส้นทาง
- ข้อความว่างพร้อมปุ่มแก้ไขในทุกหน้าหลัก
- เลือกองค์กรและ Event อัตโนมัติ พร้อมจำค่าล่าสุด
- ป้องกันเปิดหน้าที่ต้องมีองค์กร/Event ก่อน
- ตรวจความพร้อมก่อนวันแข่งขัน
- Audit Log สำหรับการแก้ไขข้อมูล
- สำรอง Event เป็น ZIP และส่งออก CSV
- Scanner แจ้งสาเหตุชัดเจนเมื่อยังขาดองค์กร/Event/จุด


# V7.2 — Detailed Manual Edition

- คู่มือออนไลน์ที่ manual/index.html
- คู่มือ PDF และ Word ฉบับละเอียดสำหรับผู้เริ่มต้น
- เปลี่ยนปุ่มคู่มือทุกหน้าเป็น V7.2
- ลบไฟล์คู่มือ V6 เก่าเพื่อป้องกันการดาวน์โหลดผิด
- เพิ่มลิงก์เปิดคู่มือออนไลน์ใน Admin, Login, Pending, Scanner และ Results


## V7.2 - Standalone Runner Result Portal

- หน้าใหม่ `runner-results/` แยกจาก `admin/` และ `scanner/`
- ไม่โหลด core.js และไม่ตรวจ Session
- ไม่มีลิงก์เข้าสู่ระบบทีมงาน
- ตารางลำดับ + ค้นหา BIB + แชร์ผล
- RPC สาธารณะคืนเฉพาะข้อมูลนักวิ่งที่อนุญาต
- หน้าผลเดิมใน Admin เปลี่ยนชื่อเป็น “ผลการแข่งขัน (ทีมงาน)”
